...
<span>Barcode : </span><input type="text" style="width:265px; height:30px;"  name="code" value="<?php echo $row['product_code']; ?>" Required/><br>
...
<select name="supplier" style="width:265px; height:30px; margin-left:-5px;" >
	...
	<?php
	$results = $db->query("SELECT * FROM supliers");
