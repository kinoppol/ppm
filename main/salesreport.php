	...
	<div class="container-fluid">
		...
		<div class="span2">
			  <div class="well sidebar-nav">
				...
				<li><a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>"><i class="icon-shopping-cart icon-2x"></i> Sales</a>  </li>                                                </li>
...
<center><strong>From : <input type="text" style="width: 223px; padding:14px;" name="d1" class="tcal" value="<?php print date("m/d/Y"); ?>" /> To: <input type="text" style="width: 223px; padding:14px;" name="d2" class="tcal" value="<?php print date("m/d/Y"); ?>" />
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<?php
				...
				$d1=pq($_GET['d1']);
				$d2=pq($_GET['d2']);
				$result = $db->query("SELECT * FROM sales WHERE date BETWEEN $d1 AND $d2 ORDER by transaction_id DESC ");
	...
	<thead>
		<tr>
			...
			<?php
				...
				$d1=$_GET['d1'];
				$d2=$_GET['d2'];
				$results = $db->query("SELECT sum(amount) FROM sales WHERE date BETWEEN $d1 AND $d2");
				...
				<th colspan="1" style="border-top:1px solid #999999">
			<?php 
				$resultia = $db->query("SELECT sum(profit) FROM sales WHERE date BETWEEN $d1 AND $d2");
