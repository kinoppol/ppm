...
?>
        ...
        <div class="card">
            <div class="p-0 clearfix">
                ...
                <div class="h5 text-primary mb-0 pt-3"><?php print number_format(empty($last_price)?0:$last_price,2); ?></div>
...
<div class="col-md-12 col-lg-12">
        <div class="card">
            <div class="p-0 clearfix">
                ...
                <div class="h5 text-primary mb-0 pt-3"><?php print number_format(empty($total)?0:$total,2); ?></div>
